<template>
  <div class="schedule">
    <nav-bar-component 
      ...
      class="nav-bar"
    ></nav-bar-component>
    <h1 class="header">Teaching Schedule</h1>
    <div class="class-schedule">
      <h2>Classes</h2>
      <div class="fitness-centers">
        <h3>LA Fitness</h3>
        <p>Vinyasa Yoga</p>
...
<style lang='sass'>
  .schedule
    ...
    grid-template-areas: "nav-bar nav-bar" "header header" "class-schedule workshops"
